inherited frmPesHistoricoAcoes: TfrmPesHistoricoAcoes
  ...
  object spbArquivo: TSpeedButton [9]
    Left = 724
    Top = 11
    Width = 41
    Height = 37
  ...
  object edtNomeArqImportado: TEdit [14]
    Left = 135
    Top = 27
    Width = 583
    Height = 21
  ...
  object edtArqImportado: TEdit [15]
    Left = 8
    Top = 27
    Width = 121
    Height = 21
  ...
  inherited qryConsulta: TFDQuery
    SQL.Strings = (
        ...
        'select a."data", h.ticker, h.precounitario, h.dividend_yield, h.' +
      ...
      'inner join dbo.tickers t on t.ticker = h.ticker '
        ...
        'inner join dbo.arquivosimportacao a on a.arquivoimportacao = h.a' +
        'rquivoimportacao ')
  end
end
